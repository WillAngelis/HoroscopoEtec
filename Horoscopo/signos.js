export let actualSign = [
  {
    nome: 'Aquário',
    cores: ['var(--red)', 'var(--yellow)'],
    data: 'Jan 20th - Fev 18th',
    img: '/img/aquario',
    sobre:
  ...
  {
    nome: 'Peixes',
    cores: ['var(--violet)', 'var(--green)'],
    data: 'Fev 19th - Mar 20th',
    img: '/img/peixes',
    sobre:
  ...
  {
    nome: 'Áries',
    cores: ['var(--blue)', 'var(--green)'],
    data: 'Mar 21th - Abr 19th',
    img: '/img/aries',
    sobre:
      'Quem tem Sol no signo de Áries pode se identificar com características como a impulsividade e a coragem. Sabe aquela galera que não tem medo de nada? Provavelmente tem Áries forte no Mapa. Eles também amam motivar quem está ao seu redor e são guerreiros por natureza (típica característica de Áries, não?)',
    caracteristica:
      'Dinâmicos e sinceros, quem tem sol em Áries costuma ter um forte contato com a sua individualidade, que pode parecer egoísmo em alguns momentos. Arianas e arianos tendem a ser alegres e muito extrovertidos, mas também podem ser bastante competitivos e soar um pouco autoritários. Podem preferir trabalhar sozinhos, mas costumam ter um ótimo espírito de liderança. Quem tem o signo de Áries em posição marcante no Mapa Astral de nascimento, geralmente, não se cansa com facilidade; sua disposição e resistência físicas podem ser invejadas por todos os outros signos. Áries é direto para alcançar suas metas e, em casos de pouca maturidade, arianas e arianos podem gostar de criar rivalidades e ser um tanto quanto mandões. Marte como regente reforça o perfil guerreiro do signo e também sinaliza possíveis explosões emocionais.',
  },
  {
    nome: 'Touro',
    cores: ['var(--pink)', 'var(--green)'],
    data: 'Abr 20th - Mai 20th',
    img: '/img/touro',
    sobre:
      'Quem nasce com o sol no signo Touro pode se identificar com virtudes como a paciência, o bom gosto e a sensualidade. Afeto e valorização do prazer e conforto também podem ser características de Touro, mas sabe aquela galera meio teimosa? Pode ser que tenham o signo de Touro forte no Mapa também...',
    caracteristica:
      'Calmo e persistente, se você tem sol no signo de Touro, provavelmente não costuma se irritar com facilidade. Em geral, suas posses e bens materiais são importantes para você. E, dependendo do restante do seu Mapa Astral, você pode usar isso ao seu favor, desenvolvendo uma tendência natural para acumular bens materiais, além de um ótimo senso de organização financeira. Mas atenção! Essa mesma característica pode despertar possessividade e materialismos excessivos. A combinação do elemento terra com a natureza fixa do signo de Touro indica possíveis dificuldades com mudanças. Taurinos, taurinas, quem tem ascendente, lua ou um acúmulo de planetas no signo Touro pode demonstrar certa lentidão para agir. Isso faz parte do senso de segurança da personalidade de touro, que costuma ser estratégico em cada passo. A terra fixa também pode indicar uma teimosia excessiva, difícil de controlar. O planeta Vênus como regente relaciona o signo ao amor cuidadoso e afetuoso. Taurinos e taurinas amam de forma prática e gentil, e é na convivência que isso se expressa da melhor maneira.',
  },

  {
    nome: 'Gêmeos',
    cores: ['var(--yellow)', 'var(--green)'],
    data: 'Mai 21th - Jun 21th',
    img: '/img/gemeos',
    sobre:
      'Quem nasce com o sol no signo de Gêmeos geralmente se identifica com características como a curiosidade, a inteligência e o desejo de liberdade. Sabe aquela galera que ama ler, aprender coisas novas, puxar conversa e fazer novas amizades? Provavelmente tem gêmeos signo forte no mapa.',
    caracteristica:
      'Curioso e bem humorado, quem tem sol no signo de Gêmeos costuma fazer amigos sem grandes dificuldades, tem uma verdadeira vocação para manter um círculo social diverso, com todas as tribos possíveis. Dois em um? Geminianos e geminianas podem ter uma personalidade versátil, que se adapta a diversas formas de pensamento e podem transitar tranquilamente por dois lados de uma questão. Mas atenção! Com imaturidade essa facilidade de mediação pode se transformar em falsidade. A combinação do elemento ar com a natureza mutável do signo indica uma facilidade de adaptação no signo de Gêmeos, além de uma inquietude por novos desafios, aprendizados e experiências. Se você tem este signo forte no Mapa Astral, ou seja, ascendente, lua ou um acúmulo de planetas em Gêmeos signo, provavelmente, odeia uma rotina massante ou exaustiva. O planeta Mercúrio como regente relaciona Gêmeos à criatividade e à comunicação.',
  },
  {
    nome: 'Câncer',
    cores: ['var(--pink)', 'var(--violet)'],
    data: 'Jun 22th - Jul 22th',
    img: '/img/cancer',
    sobre:
    ...
    caracteristica:
      'Emotivos e sensíveis, quem tem sol no signo de Câncer costuma ter uma forte conexão com as lembranças do passado, que podem contribuir para posturas muito sentimentais ou até melancólicas. Cancerianas e cancerianos podem ser muito apegados, mas costumam ter um cuidado ímpar com todas as pessoas que amam. Tendem a buscar segurança e proteção, e isso pode se demonstrar com comportamentos no dia a dia que não oferecem grandes riscos. Quem tem o signo de Câncer forte no Mapa Astral de nascimento se identifica com um forte instinto para ação guiado pelos sentimentos. Câncer consegue traçar estratégias sinuosas para alcançar seus objetivos e, em casos com pouca maturidade, podem usar de manipulação. A Lua como regente reforça o perfil maternal/ paternal do signo e também sinaliza para possíveis oscilações emocionais.',
  },
  {
    nome: 'Leão',
    cores: ['var(--orange)', 'var(--yellow)'],
    data: 'Jul 23th - Ago 22th',
    img: '/img/leao',
    sobre:
      'Quem nasce com o sol no signo Leão pode se identificar com características como a criatividade e a coragem. Sabe aquela galera com a autoestima lá em cima? Provavelmente tem Leão signo forte no mapa. A generosidade e o otimismo também podem ser bem presentes.',
    caracteristica:
  ...
  },
  {
    ...
    caracteristica:
      'A busca pela perfeição pode ser bem presente na personalidade de quem tem o sol no signo de Virgem. Naturalmente adeptos da praticidade, virginianas e virginianos podem melhorar sua auto-estima se sentindo mais úteis e produtivos. O nível elevado de autocrítica, porém, pode levá-los a subestimar seus próprios talentos com certa facilidade. Virgem também é o signo mais leal com quem ama de verdade, familiares, amigos e nos relacionamentos amorosos. O amor de Virgem signo é baseado na verdade e na maturidade, quem tem muitos planetas neste signo pode demonstrar seus sentimentos de forma mais prática. Os cuidados com a saúde e com a higiene pessoal podem ser também características fortes que mostram a consciência da importância em se cuidar para viver bem, porém, em casos menos maduros, tendem a se manifestar como mania de limpeza ou de organização.',
  },
  {
    nome: 'Libra',
    cores: ['var(--pink)'],
    data: 'Set 23th - Out 22th',
    img: '/img/libra',
    sobre:
      'Quem nasce com o sol no signo Libra, em geral, se identifica com características como a cortesia, a delicadeza e a busca constante pelo equilíbrio. Librianas e librianos típicos adoram viver relacionamentos e tendem a ter um pouco de dificuldade para tomar decisões.',
    caracteristica:
  ...
  {
    nome: 'Escorpião',
    cores: ['var(--green)', 'var(--blue)'],
    data: 'Out 23th - Nov 21th',
    img: '/img/escorpiao',
    sobre:
